...
public class tictactoe extends javax.swing.JFrame {
    ...
    public tictactoe(String jTextfield1) {
        initComponents(jTextfield1);
    }
    ...
    private void initComponents(String jTextfield1) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tictactoe("test").setVisible(true);
            }
        });
    }
